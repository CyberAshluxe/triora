...
export default function DealOfTheMonthPage() {
  ...
  useEffect(() => {
    ...
    if (savedProducts) {
      ...
      const dealProducts = allSellerProducts.filter(
        (product) => product.category === "deal-of-the-month"
      );
      setSellerProducts(dealProducts);
    }
  }, []);
  ...
  const products = {
    gaming: [
      {
        id: 1,
        name: "Tri-Aura Console X - Deal of the Month",
        originalPrice: "₦499",
        price: "₦349",
        discount: "30% Off",
      ...
      {
        id: 2,
        name: "Aura Mech Pro Keyboard - Deal of the Month",
        originalPrice: "₦159",
        price: "₦111",
        discount: "30% Off",
    ...
    skincare: [
      {
        id: 3,
        name: "Hyaluronic Acid Serum - Deal of the Month",
        originalPrice: "₦49",
        price: "₦34",
        discount: "30% Off",
    ...
    ebooks: [
      {
        id: 4,
        name: "Digital Marketing Ebook - Deal of the Month",
        originalPrice: "₦19",
        price: "₦13",
        discount: "30% Off",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-emerald-600 to-teal-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          ...
          <p className="text-lg sm:text-xl text-white/90 max-w-3xl">
            Exclusive monthly deals on top products. Don't miss out on these
            special offers!
          </p>
        </div>
      </section>
      ...
      <footer className="bg-white border-t border-gray-200 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm text-gray-600">
            &copy; 2025 Tri-Aura. All rights reserved. Deal of the Month -
            Limited Time!
          </p>
        </div>
      </footer>
