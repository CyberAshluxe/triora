...
export default function Buy2PayFor1Page() {
  ...
  useEffect(() => {
    ...
    if (savedProducts) {
      ...
      const bogoProducts = allSellerProducts.filter(
        (product) => product.category === "buy-2-pay-for-1"
      );
      setSellerProducts(bogoProducts);
    }
  }, []);
  ...
  const products = {
    gaming: [
      {
        id: 1,
        name: "Tri-Aura Console X - Buy 2 Pay for 1",
        price: "₦499",
      ...
      {
        id: 2,
        name: "Aura Mech Pro Keyboard - Buy 2 Pay for 1",
        price: "₦159",
    ...
    skincare: [
      {
        id: 3,
        name: "Hyaluronic Acid Serum - Buy 2 Pay for 1",
        price: "₦49",
    ...
    ebooks: [
      {
        id: 4,
        name: "Digital Marketing Ebook - Buy 2 Pay for 1",
        price: "₦19",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-emerald-600 to-teal-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          ...
          <p className="text-lg sm:text-xl text-white/90 max-w-3xl">
            Amazing deal! Buy two items and pay for only one. Double your
            savings!
          </p>
        </div>
      </section>
      ...
      <footer className="bg-white border-t border-gray-200 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm text-gray-600">
            &copy; 2025 Tri-Aura. All rights reserved. Buy 2 Pay for 1 - Limited
            Time Offer!
          </p>
        </div>
      </footer>
