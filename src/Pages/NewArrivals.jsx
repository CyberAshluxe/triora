...
export default function NewArrivalsPage() {
  ...
  useEffect(() => {
    ...
    if (savedProducts) {
      ...
      const newArrivalsSellerProducts = allSellerProducts.filter(
        (product) => product.category === "new-arrivals"
      );
      setSellerProducts(newArrivalsSellerProducts);
    }
  }, []);
  ...
  const products = {
    gaming: [
      {
        id: 1,
        name: "Tri-Aura Console X - New Arrival",
        price: "₦499",
      ...
      {
        id: 2,
        name: "Aura Mech Pro Keyboard - New Arrival",
        price: "₦159",
      ...
      {
        id: 3,
        name: "Aura Precision Pro Mouse - New Arrival",
        price: "₦79",
    ...
    skincare: [
      {
        id: 4,
        name: "Hyaluronic Acid Serum - New Arrival",
        price: "₦49",
      ...
      {
        id: 5,
        name: "Retinol Night Serum - New Arrival",
        price: "₦59",
    ...
    ebooks: [
      {
        id: 6,
        name: "Digital Marketing Ebook - New Arrival",
        price: "₦19",
      ...
      {
        id: 7,
        name: "Python Programming Ebook - New Arrival",
        price: "₦24",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-emerald-600 to-teal-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          ...
          <p className="text-lg sm:text-xl text-white/90 max-w-3xl">
            Discover the latest products in gaming, skincare, and e-books. Fresh
            arrivals just for you!
          </p>
        </div>
      </section>
      ...
      <footer className="bg-white border-t border-gray-200 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm text-gray-600">
            &copy; 2025 Tri-Aura. All rights reserved. Discover the latest
            arrivals!
          </p>
        </div>
      </footer>
