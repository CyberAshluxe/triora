...
export default function UpTo80OffPage() {
  ...
  useEffect(() => {
    ...
    if (savedProducts) {
      ...
      const clearanceProducts = allSellerProducts.filter(
        (product) => product.category === "up-to-80-off"
      );
      setSellerProducts(clearanceProducts);
    }
  }, []);
  ...
  const products = {
    gaming: [
      {
        id: 1,
        name: "Tri-Aura Console X - Up to 80% Off",
        originalPrice: "₦499",
        price: "₦99",
        discount: "80% Off",
      ...
      {
        id: 2,
        name: "Aura Mech Pro Keyboard - Up to 80% Off",
        originalPrice: "₦159",
        price: "₦31",
        discount: "80% Off",
    ...
    skincare: [
      {
        id: 3,
        name: "Hyaluronic Acid Serum - Up to 80% Off",
        originalPrice: "₦49",
        price: "₦9",
        discount: "80% Off",
    ...
    ebooks: [
      {
        id: 4,
        name: "Digital Marketing Ebook - Up to 80% Off",
        originalPrice: "₦19",
        price: "₦3",
        discount: "80% Off",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-emerald-600 to-teal-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          ...
          <p className="text-lg sm:text-xl text-white/90 max-w-3xl">
            Massive clearance sale! Get incredible discounts on a wide range of
            products.
          </p>
        </div>
      </section>
      ...
      <footer className="bg-white border-t border-gray-200 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm text-gray-600">
            &copy; 2025 Tri-Aura. All rights reserved. Up to 80% Off - Clearance
            Sale!
          </p>
        </div>
      </footer>
