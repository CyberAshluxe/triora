        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <section className="py-12 bg-gray-50 mt-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <h2 className="text-3xl font-bold text-center mb-8">Our Shipping Services</h2>
          ...
          <section className="py-12 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <p className="text-gray-600 mb-8">Contact us for any shipping-related inquiries or to arrange secure package delivery.</p>
